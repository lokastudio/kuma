...
- [x] **6.3** `ServiceStore` (@Observable Service Management & Auto-Start Restoration Logic via `ServiceAggregate`)
- [x] **6.4** `KubeConfigStore` (@Observable KubeContext Sync & FSEvents Observer)
